...
#let template(
  ...
  let logo = [
    ...
    #v(-13pt)
    #align(center)[
      #text(size: 15pt, style: "italic", weight: "bold", fill: theme.color, font: theme.font, bnextTitle)
    ]
    #v(13pt)
  ]
  ...
  let margin = (
    ...
    (
      ...
      content: [
        #set par(justify: true)
        #set text(size: 7pt)
        The materials and processes described in this article are distributed under the terms of the CERN Open Hardware License Permissive 2.0, which enables reusers to make and convey any component or device that apply the information made explicitly available under this license, so long as all notices are retained.
      ]
    ),
